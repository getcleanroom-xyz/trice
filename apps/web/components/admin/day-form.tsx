      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col gap-1.5">
          ...
          <select
            id="topicId"
            {...register("topicId")}
            className="flex h-10 w-full rounded-sm border border-input bg-transparent px-3.5 py-2 text-sm text-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
          >
            {topics.map((t) => (
